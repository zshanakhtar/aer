...
<td colspan="2">
	<a class="btn btn-info col-xs-12" href="request/getsummary.php?app_id=<?php echo $app_id;?>" target="_blank" >
		<span class="glyphicon glyphicon-floppy-save"></span>
		<span>Preview Uploaded Summary</span>
	</a>
</td>
<td colspan="5">
	<button type="text" class="btn btn-warning col-xs-4 col-xs-offset-1" onclick="submitform(0)" >
		<span class="glyphicon glyphicon-ban-circle"></span>
		<span>Reject</span>
	</button>
    <button type="text" class="btn btn-danger col-xs-4 col-xs-offset-2" onclick="submitform(1)" >
